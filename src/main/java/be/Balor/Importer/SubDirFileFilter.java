...
/**
 * Implements a {@link java.io.FileFilter FileFilter} to return files matching a
 * given pattern.</br> It also can search all sub-directories by a recursive
 * implementation.</br> You can also use the Type to only search for DIRS. </p>
 * Example:
 * 
 * <pre>
...
public class SubDirFileFilter {
	 ...
	 */
	public final List<File> getFiles(final File basedir,
			final FileFilter filter, boolean recursive) {
	...
	public enum Type implements FileFilter {
		...
		public boolean accept(final File file) {
			return file != null
					&& (this == ALL || (this == FILE && file.isFile()) || (this == DIR && file
							.isDirectory()));
		}
	}
